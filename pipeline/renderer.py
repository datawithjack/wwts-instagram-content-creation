...
def render_h2h_carousel(
    data: dict,
    output_dir: str,
    base_name: str = "h2h_carousel",
    width: int = 1080,
    height: int = 1350,
    dpr: int = 2,
) -> list[str]:
    """Render H2H carousel data into 5 or 6 slide PNGs.
...
def render_rp_carousel(
    data: dict,
    output_dir: str,
    base_name: str = "rp_carousel",
    width: int = 1080,
    height: int = 1350,
    dpr: int = 2,
) -> list[str]:
...
def render_finals_preview_carousel(
    data: dict,
    output_dir: str,
    base_name: str = "finals_preview",
    width: int = 1080,
    height: int = 1350,
    dpr: int = 2,
) -> list[str]:
    """Render the finals preview carousel into 2 slide PNGs (men, women).
